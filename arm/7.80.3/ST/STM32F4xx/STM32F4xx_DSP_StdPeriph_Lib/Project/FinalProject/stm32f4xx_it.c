...
__IO extern uint32_t encoderFrequency = 0;
__IO uint16_t TIM5_CC2_sigLevel = 0;
...
void TIM5_IRQHandler(void){
  ...
  __IO uint16_t IC2ReadValue1 = 0;
  __IO uint16_t IC2ReadValue2 = 0;
  __IO uint16_t IC2ReadValue3 = 0;
